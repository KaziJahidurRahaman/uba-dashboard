...
class Person(models.Model):
    ...
    created_at = models.DateTimeField(null=True, auto_now_add = True,  db_column='created_at')
...
class SampleType(models.Model):
    ...
    sample_type_code = models.CharField(unique=True, db_column='sample_type_code', max_length=7, verbose_name='7 digit code of measurment types')
...
class Sample(models.Model):
    ...
    sample_type = models.ForeignKey(SampleType,to_field='sample_type_code', on_delete=models.DO_NOTHING, db_column='SampleType')
...
class ActivityType(models.Model):
    activitytype_id = models.BigAutoField(primary_key=True)
    activity_name = models.CharField(unique=True, db_column='activity_name', max_length=20, verbose_name='name i.e Watering, Crop')
    activity_unit = models.CharField(db_column='activity_unit', null = True, default = None,max_length=20, verbose_name='name i.e Watering, Crop')
    activity_type_comment = models.TextField(null=True, default=None)
    created_at = models.DateTimeField(null=True, default=None)
...
class Activity(models.Model):
    ...
    activity_type = models.ForeignKey(ActivityType, to_field = 'activitytype_id', on_delete=models.DO_NOTHING, db_column='activity_type')
